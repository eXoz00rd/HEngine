...
public class TextureLoadResultTests
{
    ...
    public void Constructor_SetsAllProperties()
    {
        ...
        var result = new TextureLoadResult(data, 4, 4, 1, TextureFormat.R8G8B8A8Unorm, 4, false, "test.png");
    ...
    public void Constructor_ThrowsOnNullData()
    {
        Assert.Throws<ArgumentNullException>(() =>
            new TextureLoadResult(null!, 4, 4, 1, TextureFormat.R8G8B8A8Unorm, 4, false, "test.png"));
    }
    ...
    public void Constructor_ThrowsOnZeroWidth()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new TextureLoadResult(new byte[16], 0, 4, 1, TextureFormat.R8G8B8A8Unorm, 4, false, "test.png"));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new TextureLoadResult(new byte[16], 4, 0, 1, TextureFormat.R8G8B8A8Unorm, 4, false, "test.png"));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new TextureLoadResult(new byte[16], 4, 4, 0, TextureFormat.R8G8B8A8Unorm, 4, false, "test.png"));
    }

    [Fact]
    public void RowPitch_CalculatedCorrectly()
    {
        var result = new TextureLoadResult(new byte[64], 4, 4, 1, TextureFormat.R8G8B8A8Unorm, 4, false, "test.png");
    ...
    {
        var result = new TextureLoadResult(new byte[8], 4, 4, 1, TextureFormat.BC1Unorm, 0, true, "test.dds");
    ...
    public void SliceSize_UsesDataLengthForCompressed()
    {
        ...
        var result = new TextureLoadResult(data, 4, 4, 1, TextureFormat.BC1Unorm, 0, true, "test.dds");
    ...
    {
        var result = new TextureLoadResult(new byte[16], 2, 2, 1, TextureFormat.R8G8B8A8Unorm, 4, false, null!);
